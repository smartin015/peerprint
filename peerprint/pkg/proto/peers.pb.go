...
type PeerStatus struct {
	...
	Name    string          `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // Human-readable name of this server/peer
	Clients []*ClientStatus `protobuf:"bytes,2,rep,name=clients,proto3" json:"clients,omitempty"`
}
...
func (x *PeerStatus) GetClients() []*ClientStatus {
	if x != nil {
		return x.Clients
	}
	return nil
...
// Clients connect to the Network via Peers (Servers).
// This allows us to see the detailed state of all workers conneted to
// a specific server.
type ClientStatus struct {
	...
	Name         string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`                                     // Human-readable
	ActiveRecord string `protobuf:"bytes,2,opt,name=active_record,json=activeRecord,proto3" json:"active_record,omitempty"` // What record they they are working on
	ActiveUnit   string `protobuf:"bytes,3,opt,name=active_unit,json=activeUnit,proto3" json:"active_unit,omitempty"`       // What part of the record they are working on
	Status       string `protobuf:"bytes,4,opt,name=status,proto3" json:"status,omitempty"`                                 // Short display string of current status
	Profile      string `protobuf:"bytes,5,opt,name=profile,proto3" json:"profile,omitempty"`                               // Description of the client's cababilities
	// Approximate location
	Location  *Location `protobuf:"bytes,6,opt,name=location,proto3" json:"location,omitempty"`
	Timestamp int64     `protobuf:"varint,7,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // When was this status given
}
...
func (x *ClientStatus) GetActiveRecord() string {
	if x != nil {
...
func (x *ClientStatus) GetActiveUnit() string {
	if x != nil {
		return x.ActiveUnit
	}
	return ""
...
func (x *ClientStatus) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *ClientStatus) GetProfile() string {
	if x != nil {
		return x.Profile
	}
	return ""
...
func (x *ClientStatus) GetLocation() *Location {
	if x != nil {
		return x.Location
	}
	return nil
...
func (x *ClientStatus) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
type NetworkConfig struct {
	...
	ExtraBootstrapPeers []string `protobuf:"bytes,11,rep,name=extra_bootstrap_peers,json=extraBootstrapPeers,proto3" json:"extra_bootstrap_peers,omitempty"`
	ExtraRelayPeers     []string `protobuf:"bytes,12,rep,name=extra_relay_peers,json=extraRelayPeers,proto3" json:"extra_relay_peers,omitempty"`
}
...
func (x *NetworkConfig) GetExtraBootstrapPeers() []string {
	if x != nil {
...
func (x *NetworkConfig) GetExtraRelayPeers() []string {
	if x != nil {
...
var file_peers_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x72, 0x73, 0x22, 0x44, 0x0a, 0x08, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0x4f, 0x0a, 0x0a, 0x50, 0x65,
	...
	,
	...
	0x07, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x2b, 0x0a, 0x08, 0x6c, 0x6f, 0x63, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x65, 0x65,
	...
	,
	...
	0x6c, 0x69, 0x6e, 0x6b, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x1e, 0x0a, 0x0a, 0x72, 0x65, 0x6e, 0x64, 0x65, 0x7a, 0x76, 0x6f, 0x75, 0x73, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x72, 0x65, 0x6e, 0x64, 0x65, 0x7a, 0x76, 0x6f, 0x75,
	...
	,
	...
	,
...
var file_peers_proto_goTypes = []interface{}{
	(*Location)(nil),         // 0: peers.Location
	(*PeerStatus)(nil),       // 1: peers.PeerStatus
	(*ClientStatus)(nil),     // 2: peers.ClientStatus
	(*AddrInfo)(nil),         // 3: peers.AddrInfo
	(*GetPeersRequest)(nil),  // 4: peers.GetPeersRequest
	(*GetPeersResponse)(nil), // 5: peers.GetPeersResponse
	(*GetStatusRequest)(nil), // 6: peers.GetStatusRequest
	(*NetworkConfig)(nil),    // 7: peers.NetworkConfig
	(*NetworkStats)(nil),     // 8: peers.NetworkStats
	(*Network)(nil),          // 9: peers.Network
	(*PubKeyExchange)(nil),   // 10: peers.PubKeyExchange
	(*EncryptedPSK)(nil),     // 11: peers.EncryptedPSK
}
var file_peers_proto_depIdxs = []int32{
	2, // 0: peers.PeerStatus.clients:type_name -> peers.ClientStatus
	0, // 1: peers.ClientStatus.location:type_name -> peers.Location
	3, // 2: peers.GetPeersResponse.Addresses:type_name -> peers.AddrInfo
	7, // 3: peers.Network.config:type_name -> peers.NetworkConfig
	8, // 4: peers.Network.stats:type_name -> peers.NetworkStats
