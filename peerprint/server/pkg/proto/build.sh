...
sed -i 's/import command_pb2/import peerprint.server.pkg.proto.command_pb2/g' ./*.py
sed -i 's/import state_pb2/import peerprint.server.pkg.proto.state_pb2/g' ./*.py
