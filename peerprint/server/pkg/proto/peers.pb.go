...
func (x *PeerTrack) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PeerTrack) ProtoMessage() {}

func (x *PeerTrack) ProtoReflect() protoreflect.Message {
	mi := &file_proto_peers_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PeerTrack.ProtoReflect.Descriptor instead.
func (*PeerTrack) Descriptor() ([]byte, []int) {
	return file_proto_peers_proto_rawDescGZIP(), []int{4}
}

func (x *PeerTrack) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PeerTrack) GetFirstSeen() int64 {
	if x != nil {
		return x.FirstSeen
	}
	return 0
...
func (x *PeerTrack) GetLastSeen() int64 {
	if x != nil {
		return x.LastSeen
	}
	return 0
...
func (x *PeerSample) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PeerSample) ProtoMessage() {}

func (x *PeerSample) ProtoReflect() protoreflect.Message {
	mi := &file_proto_peers_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PeerSample.ProtoReflect.Descriptor instead.
func (*PeerSample) Descriptor() ([]byte, []int) {
	return file_proto_peers_proto_rawDescGZIP(), []int{5}
}

func (x *PeerSample) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PeerSample) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_proto_peers_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x65, 0x73, 0x22, 0x57, 0x0a, 0x09, 0x50, 0x65, 0x65, 0x72, 0x54, 0x72, 0x61, 0x63,
	0x6b, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69,
	0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x66, 0x69, 0x72, 0x73, 0x74, 0x5f, 0x73, 0x65, 0x65, 0x6e, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x66, 0x69, 0x72, 0x73, 0x74, 0x53, 0x65, 0x65, 0x6e,
	0x12, 0x1b, 0x0a, 0x09, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x73, 0x65, 0x65, 0x6e, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x08, 0x6c, 0x61, 0x73, 0x74, 0x53, 0x65, 0x65, 0x6e, 0x22, 0x3a, 0x0a,
	0x0a, 0x50, 0x65, 0x65, 0x72, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69,
...
var file_proto_peers_proto_goTypes = []interface{}{
	...
	(*PeerTrack)(nil),        // 4: peers.PeerTrack
	(*PeerSample)(nil),       // 5: peers.PeerSample
}
