...
@pytest.fixture
def ec_1j(ec, a0pay):
    ec.postJob(JID, UIDX, WIDX, COMPAT, a0pay)
    yield ec
...
def test_post_same_user_slot_diff_user(ec_1j, a0, a1):
    ...
    ec_1j.postJob(JID2, UIDX, 1, COMPAT, a1)
